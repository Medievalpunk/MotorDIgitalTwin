...
(cl:defmethod cl:initialize-instance :after ((m <SetFloat-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFloat-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ecu_msgs-srv:<SetFloat-request> is deprecated: use ecu_msgs-srv:SetFloat-request instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <SetFloat-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ecu_msgs-srv:value-val is deprecated.  Use ecu_msgs-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetFloat-request>)))
  ...
  "38182d080345fe1cb5b538699e1a64ec")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetFloat-request)))
  "Returns md5sum for a message object of type 'SetFloat-request"
  "38182d080345fe1cb5b538699e1a64ec")
...
(cl:defmethod cl:initialize-instance :after ((m <SetFloat-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFloat-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ecu_msgs-srv:<SetFloat-response> is deprecated: use ecu_msgs-srv:SetFloat-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <SetFloat-response>))
