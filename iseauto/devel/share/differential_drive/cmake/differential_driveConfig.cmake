...
if("TRUE" STREQUAL "TRUE")
  set(differential_drive_SOURCE_PREFIX /home/user/iseauto/src/differential-drive)
  set(differential_drive_DEVEL_PREFIX /home/user/iseauto/devel)
  ...
  set(differential_drive_INSTALL_PREFIX /home/user/iseauto/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'differential_drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/iseauto/src/differential-drive/${idir}'.  ${_report}")
    endif()
